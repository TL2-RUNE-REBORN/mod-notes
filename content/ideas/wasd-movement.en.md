...
- **Pathfinding, collision, ground snapping, turning, and walk animations** are all handled by the engine's native logic, so nothing needs reinventing;
