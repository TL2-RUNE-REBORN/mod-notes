...
> The full in-game content mounted by "MIKURO Game Enhancement" (Azure Lotus gems, sockets 5→10, Beast Taunt) now has its own page in the Armory → **[MIKURO Runtime MOD](/en/tools/mikuro-runtime-mod/)**. This page tracks version changes only.
